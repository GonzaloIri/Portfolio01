          ...
          <div class="col-12 pb-3">
            ...
            <div class="row">
              <div class="col-sm-4 col-12 mb-3">
                <div class="proyecto">
                  <img
                    src="images/abmclientes.png"
                    alt="ABM Clientes"
                    class="img-fluid"
                  />
                  <h2 class="px-3 py-2">ABM Clientes</h2>
                  <p class="px-3 py-1">
                    Alta, baja y modificacion de un registro de clientes.
                    Realizado en HTML, CSS, PHP, Bootstrap y Json
                  </p>
              ...
              <div class="col-sm-4 col-12 mb-3">
                <div class="proyecto">
                  ...
                  <p class="px-3 py-1">
                    ...
                    Realizado en HTML, CSS, PHP, MVC, Bootstrap, Js, Ajax,
                    jQuery y MySQL de base de datos.
                  </p>
                  <div class="row py-4 pb-3 px-3">
                    <div class="col-6">
                      <a href="#" class="btn btn-rojo"> Ver Online</a>
              ...
              <div class="col-sm-4 col-12 mb-3">
                <div class="proyecto">
                  <img
                    src="images/proyecto-integrador.png"
                    alt="ABM Ventas"
                    class="img-fluid"
                  />
                  <h2 class="px-3 py-2">PROYECTO INTEGRADOR</h2>
                  <p class="px-3 py-1">
                    Proyecto Full Stack desarrollado en PHP, Laravel,
                    Javascript, jQuery, AJAX, HTML, CSS, Mercadopago con panel
                    administrador, gestor de usuarios, módulo de permisos y
